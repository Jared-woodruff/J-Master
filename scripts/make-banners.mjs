...
const hero = `<svg xmlns="http://www.w3.org/2000/svg" width="860" height="170" viewBox="0 0 860 170">
  ...
  <text x="846" y="40" text-anchor="end" ${MONO} font-size="10" letter-spacing="2" fill="${SPEC}">REV 2.2</text>
  <text x="846" y="56" text-anchor="end" ${MONO} font-size="10" letter-spacing="2" fill="${SPEC}">WIN X64</text>
</svg>`;
